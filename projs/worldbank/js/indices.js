...
function get_goodness(question_id, match_by){
	...
	function find_best_answer(question_id){
		var yes_questions =	['out_emp', 'respect_cbo', 'vote', 'soc_dem_iss', 'prob_solve', 'pol_involve', 'comp_use', 'dec_marriage', 'last_pers_eat', 'land', 'house', 'livestock', 'poultry', 'tv', 'vehicles', 'elec_app', 'houseextension', 'personal_mobile', 'cant_text_read'];
